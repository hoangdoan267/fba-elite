...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size('thumbnail', 470, 246, true);
    add_image_size('profile', 500, 500, true); // Custom Thumbnail Size call using the_post_thumbnail('custom-size');
...
function wpb_tags() {
    ...
    foreach ($wpbtags as $tag) {
        $string .= "<a class='tag-box' href='".get_tag_link($tag->term_id)."'>".$tag->name."</a>";
    }
    echo $string;
}

function add_to_subcriber_group($user_email) {
    $groupsApi = (new \MailerLiteApi\MailerLite('3952391afe5aed9194db9a686a877222'))->groups();
...
function add_forum_link($output) {
        $output .= '<li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Dự án khác <span class="caret"></span></a>
          <ul class="dropdown-menu" id="dropdown-menu">
            <li><a href="https://www.facebook.com/gottalentsftu/">FBA’s Got Talent</a></li>
            <li><a href="http://www.wilmarclvawards.com/">Wilmar CLV Awards</a></li>
          </ul>
        </li>';
        return $output;
}
